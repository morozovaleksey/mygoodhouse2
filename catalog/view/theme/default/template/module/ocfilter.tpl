...
<div class="ocfilter " id="ocfilter">
    <div class="">
        <select id="input-sort" class="form-control" onchange="location = this.value;">
            <?php foreach ($sorts as $sorts) { ?>
                ...
                <?php if ($sorts['value'] == $sort_sort . '-' . $order_order) { ?>
  ...
  <h6 class="title  hidden-xs">ОТФИЛЬТРОВАТЬ</h6>
  <div class="hidden" id="ocfilter-button">
    <button class="btn btn-primary show-items disabled" data-loading-text="<i class='fa fa-refresh fa-spin'></i> Загрузка.."></button>
  </div>
