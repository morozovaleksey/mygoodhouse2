...
<div id="content">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-price2">Цена за шт.</label>
                <div class="col-sm-10">
                  <input type="text" name="price2" value="<?php echo $price2; ?>" placeholder="Цена за шт" id="input-price2" class="form-control" />
                </div>
              </div>
              <div class="form-group">
  ...
  <script type="text/javascript"><!--
    ...
    $('#input-short-description<?php echo $language['language_id']; ?>').summernote({height: 300, lang:'<?php echo $lang; ?>'});
    <?php } ?>
    <?php } ?>
    //--></script>
  <script type="text/javascript"><!--
