...
class ControllerCatalogCategory extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
		...
		if (isset($this->request->post['back_image'])) {
			$data['image'] = $this->request->post['back_image'];
		} elseif (!empty($category_info)) {
			$data['back_image'] = $category_info['back_image'];
		} else {
			$data['back_image'] = '';
		}
		...
		if (isset($this->request->post['back_image']) && is_file(DIR_IMAGE . $this->request->post['back_image'])) {
			$data['back_thumb'] = $this->model_tool_image->resize($this->request->post['back_image'], 100, 100);
		} elseif (!empty($category_info) && is_file(DIR_IMAGE . $category_info['back_image'])) {
			$data['back_thumb'] = $this->model_tool_image->resize($category_info['back_image'], 100, 100);
		} else {
